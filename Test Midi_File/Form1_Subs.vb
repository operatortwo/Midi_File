...
Partial Public Class Form1
    ...
    Private Sub ListEvents(TrackNr As Integer)
        ...
        For i = 1 To Mid.TrackList(TrackNr).EventList.Count

            ev = Mid.TrackList(TrackNr).EventList(i - 1)
        ...
        lblNrOfItems.Text = CStr(Mid.TrackList(TrackNr).EventList.Count)
